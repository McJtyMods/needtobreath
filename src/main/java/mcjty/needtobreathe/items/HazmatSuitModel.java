...
public class HazmatSuitModel extends ModelBiped {
    ...
    private void setupHelmet() {
        ...
        this.mask.addBox(-4.5F, -9.0F, -4.6F, 9, 13, 9, 0.0F);
        ...
        this.glove_r.addBox(-3.5F, 6.0F, -2.5F, 5, 4, 5, 0.0F);
        ...
        this.leg_l.addBox(-2.0F, -3.0F, -2.55F, 5, 9, 5, 0.0F);
        ...
        this.leg_r.addBox(-3.0F, -3.0F, -2.55F, 5, 9, 5, 0.0F);
        ...
        this.boot_l.addBox(-2.0F, 6.0F, -2.5F, 5, 6, 5, 0.0F);
        ...
        this.boot_r.addBox(-2.95F, 6.0F, -2.5F, 5, 6, 5, 0.0F);
    }
